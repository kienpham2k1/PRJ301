                    ...
                    <div class="col-lg-6">
                        <nav class="header__menu">
                            <ul>
                                <li><a href="MainController?action=Search&search=&index=1">Shop</a></li>
                                <li><a href="./shoping-cart.jsp">Shoping Cart</a></li>
                                <li><a href="MainController?action=PROCEED TO CHECKOUT">Check Out</a></li> </ul>
                        </nav>
                    </div>
                        ...
                        <div class="hero__search">
                            <div class="hero__search__form">
                                <form action="MainController"> 
                                    <input type="text" placeholder="What do you need?" value="${param.search}" name="search">
                ...
                <div class="container">
                    <div class="row">                   
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="row">
                                <c:forEach var="prod" items="${requestScope.LIST_PRODUCT}">
                                    <div class="col-lg-4 col-md-6 col-sm-6">
                                        <div class="product__item">
                                            <div class="product__item__pic set-bg" data-setbg="${prod.image}">
                                                <ul class="product__item__pic__hover">
                                                    <form action="MainController">
                                                        <input style="width: 45px" type="number" name="quantity" value="1">
                                                        ...
                                                        <input type="hidden" name="catagoryID" value="${prod.catagoryID}">
                                                        <input type="hidden" name="importDate" value="${prod.importDate}">
                                                        <input type="hidden" name="usingDate" value="${prod.usingDate}">
                                            ...
                                            <div class="product__item__text">
                                                ...
                                                <h5>${prod.price}</h5>
                                                <h6><a href="#">Using date ${prod.usingDate}</a></h6>
                                                <h6 style="color: orange">Instock: ${prod.quantity}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </c:forEach>
